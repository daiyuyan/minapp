...
Page({
  ...
  onShow: function () {
    ...
    this.setData({
      ...
      class: this.data.info.class,
      hometown: this.data.info.hometown,
      ispoor: this.data.info.ispoor,
      medicalhis: this.data.info.medicalhis,
      parcontact: this.data.info.parcontact,
      parentname: this.data.info.parentname,
      post: this.data.info.post,
      supervisor: this.data.info.supervisor
    });
  },
